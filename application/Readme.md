# Just download the dist folder, make sure output folder exists if there is no output folder then the program will not run 
> Just download the file 

## Current version supports only Windows (no support for mac/ or other linux distros)

## Updating versions (for future refrence)

> Run this to download all the dependencies
>> pip install tkinter docx npttf2utf pyinstaller
